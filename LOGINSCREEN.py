...
entry_box1=Entry(window,font=(30),textvariable=var2,bd=3,show="*",relief="groove")
entry_box1.place(x=655,y=320,width=350,height=40)

login_button=Button(window,text="LOGIN",font=(15),bg="#BBC6EE",relief="groove",command=Final)
